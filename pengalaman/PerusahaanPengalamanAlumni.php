...
<?php
        ...
        $sql_pilihan="select * from `$tbpilihan` where `id_alumni`='$id_alumni'";
        $dp=getField($conn,$sql_pilihan);
        $id_pilihan = $dp['id_pilihan'];
                           ...
                           <!-- Textual inputs start -->
                                  <div class="col-xl-12 col-lg-8 mt-5">
                                      <div class="card">
                                          ...
                                          <a href="?mnu=perusahaanPilihan&pro=ubah&kode=<?php echo $id_pilihan;?>"><input name="Pilihan" type="button" id="Pilihan" class="btn btn-primary mb-3" value="Pilih Alumni ini" /></a>
                                          <a href="?mnu=perusahaanPilihan"><input name="Batal" type="button" id="Batal" class="btn btn-danger mb-3" value="Kembali" /></a>    
                                       </div>
                                  </div>
                              </div>
                          </div>
