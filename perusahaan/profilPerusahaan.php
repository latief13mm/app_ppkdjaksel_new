                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="?mnu=profilPerusahaan2"><input name="Batal" type="button" id="Batal" class="btn btn-primary mb-3" value="Update Profil" /></a>
                            </form>
                        </div>
                    </div>
                </div>
